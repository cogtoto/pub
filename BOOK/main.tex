...
Il permet d'identifier de manière claire la frontière entre le calcul et
le raisonnement.

Nous en montrerons plusieurs exemples significatifs avec le langage \textsc{Coq} et \textsc{Agda}.
\vspace{0.3cm}
Bonne lecture !
